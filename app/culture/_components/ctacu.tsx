...
export default function CTACu({ locale }: { locale: string }) {
  const { t } = useTranslation("common");
  console.log(`CTAA: locale=${locale}, t is function: ${typeof t === "function"}`);
  ...
  if (typeof t !== "function") {
    console.warn(`CTAA: t is not a function for locale ${locale}`);
    return null;
  }
