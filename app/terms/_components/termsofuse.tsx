...
const TermsOfUse = () => {
  ...
  const tableOfContents = [
    ...
    { id: "definitions", title: "Role of Musical Mindz" },
        ...
        >
          ...
          <section id="introduction" className="mb-6">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              These Terms and Conditions govern the use of the Musical Mindz platform (&apos;the Platform&apos;) operated by [Your Company Name], including the website, mobile application, and all related services. By registering or using the Platform, users accept these Terms in full.
          ...
          <section id="definitions" className="mb-6">
            <h2 className="text-xl font-semibold  mb-2">2. Role of Musical Mindz</h2>
            <p className="text-gray-700 dark:text-gray-300">
              Musical Mindz is a <span className="font-semibold">neutral digital intermediary</span>. We <span className="font-semibold">do not provide musical services ourselves</span>, and we <span className="font-semibold">are not a contracting party</span> to agreements made between End Users and Providers.
            </p>
            <p className="text-gray-700 dark:text-gray-300">Musical Mindz is <span className="font-semibold">not liable</span> for:</p>
          ...
          <section id="User" className="mb-6">
            ...
            <ul className="list-disc pl-5 mt-2 text-gray-700 dark:text-gray-300">
              ...
              <li>Musical Mindz may suspend or delete accounts in case of abuse, fraud, or breach of terms.</li>
            </ul>
          </section>
          <section id="Bookings" className="mb-6">
            ...
            <ul className="list-disc pl-5 mt-2 text-gray-700 dark:text-gray-300">
              ...
              <li>Musical Mindz charges a <span className="font-semibold">10%</span> service fee per successful booking.</li>
            ...
            <p>Musical Mindz is not liable for missed sessions, non-performance, or dissatisfaction unless caused by technical failures of the Platform.</p>
          </section>
          <section id="Subscription" className="mb-6">
            ...
            <p>Refunds are generally excluded unless due to <span className="font-semibold">technical issues caused by Musical Mindz.</span> Any <span className="font-semibold">goodwill refunds</span> are issued <span>without legal entitlement.</span></p>
          </section>
          <section id="ratings" className="mb-6">
            ...
            <ul className="list-disc pl-5 mt-2 text-gray-700 dark:text-gray-300">
              ...
              <li>Musical Mindz reserves the right to moderate or delete content without justification.</li>
            </ul>
            <p>By uploading content (e.g., audio, images), users grant Musical Mindz a <span className="font-semibold">non-exclusive, worldwide license</span> to display it on the Platform for promotional and functional purposes.</p>
          </section>
          <section id="limitation" className="mb-6">
            <h2 className="text-xl font-semibold  mb-2">7. Limitation of Liability</h2>
            <p>To the fullest extent permitted by law, Musical Mindz shall not be liable for:</p>
            <ul className="list-disc pl-5 mt-2 text-gray-700 dark:text-gray-300">
          ...
          <section id="termination" className="mb-6">
            ...
            <ul className="list-disc pl-5 mt-2 text-gray-700 dark:text-gray-300">
              ...
              <li>Musical Mindz may terminate access in cases of fraud, abuse, or legal violations.</li>
          ...
          <section id="contact" className="mb-6">
            ...
            <p>Musical Mindz / [Your Company Legal Name]
              [Address]
              [Email]
